...
/* CIntToPy */
static CYTHON_INLINE PyObject* __Pyx_PyInt_From_enum__ssh_scp_request_types(enum ssh_scp_request_types value) {
    const enum ssh_scp_request_types neg_one = (enum ssh_scp_request_types) ((enum ssh_scp_request_types) 0 - (enum ssh_scp_request_types) 1), const_zero = (enum ssh_scp_request_types) 0;
