 ...
 */
      ...
      __pyx_t_8 = __Pyx_PyInt_As_int(__pyx_t_4); if (unlikely((__pyx_t_8 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 53, __pyx_L3_error)
...
static int __Pyx_modinit_type_import_code(void) {
  ...
  __pyx_ptype_3ssh_9connector_Connector = __Pyx_ImportType_3_0_11(__pyx_t_1, "ssh.connector", "Connector", sizeof(struct __pyx_obj_3ssh_9connector_Connector), __PYX_GET_STRUCT_ALIGNMENT_3_0_11(struct __pyx_obj_3ssh_9connector_Connector),__Pyx_ImportType_CheckSize_Warn_3_0_11); if (!__pyx_ptype_3ssh_9connector_Connector) __PYX_ERR(4, 29, __pyx_L1_error)
