...
static int __Pyx_modinit_type_import_code(void) {
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_ptype_3ssh_4sftp_SFTP = __Pyx_ImportType_3_0_11(__pyx_t_1, "ssh.sftp", "SFTP", sizeof(struct __pyx_obj_3ssh_4sftp_SFTP), __PYX_GET_STRUCT_ALIGNMENT_3_0_11(struct __pyx_obj_3ssh_4sftp_SFTP),__Pyx_ImportType_CheckSize_Warn_3_0_11); if (!__pyx_ptype_3ssh_4sftp_SFTP) __PYX_ERR(3, 22, __pyx_L1_error)
