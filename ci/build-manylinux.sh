...
docker_files=("ci/docker/manylinux/Dockerfile" "ci/docker/manylinux/Dockerfile.2014_x86_64"
              "ci/docker/Dockerfile.manylinux_2_24_x86_64" "ci/docker/Dockerfile.manylinux_2_28_x86_64")
...
if [[ $(uname -m) == "aarch64" ]]; then
    ...
    docker_files=("ci/docker/manylinux/Dockerfile.aarch64" "ci/docker/Dockerfile.aarch64_2_24"
